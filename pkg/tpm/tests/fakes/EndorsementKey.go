...
var GetFakeEndorsementKeyValid = func() *tpm.EndorsementKeyData {
	fake := tpm.EndorsementKeyData{}
...
var GetFakeEndorsementKeyInvalid = func() *tpm.EndorsementKeyData {
	return &tpm.EndorsementKeyData{
		PK: &rsa.PublicKey{
			N: big.NewInt(0),
			E: 65537,
		},
